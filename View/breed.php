            ...
            <div id ="breed-mother" >
                ...
                <div id="breed-phenotype" >
                    ...
                    <table class="breed-pheno-table table table-bordered table-sm" style="float: right;">
                        ...
                        <tr>
                            <td>Markings</td><td><?php echo $phenotype[5]; ?></td> <td>Height:</td><td><?php echo $mPheno->getHeight();?> cm</td> 
                        </tr>
                        <tr>
                            <td>Tameness</td><td><?php echo $mPheno->getTameness();?>/<?php echo $mPheno->getMaxTameness();?></td> <td>Weight</td><td><?php echo $mPheno->getWeight();?> kg</td>
                        </tr>
                    </table>
        ...
        <div class="col-5">
            <div id ="breed-father">
                 <select name="selectFather" onchange="updateDisplayGriffM()" form="breed-form" required id="selectFather"> 
                    <?php foreach($mBreedable as $griff){ ?>
                    <option value="<?php echo $griff->getId(); ?>"> <?php echo $griff->getName(); ?></option>
                    <?php } ?>
                </select>
                <div id="breed-phenotype">
                  <?php foreach ($mBreedable as $fPheno){ 
                        $phenotype = Breeder::punnet($fPheno->getGenome());
                    ?>
                    <div id="<?php echo $fPheno->getId(); ?>" style="display: none;" class="toggleableM">
                    <table class="breed-pheno-table table table-bordered table-sm" style="float: left;">
                        <tr>
                            <td>Color</td><td><?php echo $phenotype[0]; ?></td> <td>Skin</td><td><?php echo $phenotype[7]; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Markings</td><td><?php echo $phenotype[5]; ?></td> <td>Height:</td><td><?php echo $fPheno->getHeight();?> cm</td> 
                        </tr>
                        <tr>
                            <td>Tameness</td><td><?php echo $fPheno->getTameness();?>/<?php echo $fPheno->getMaxTameness();?></td> <td>Weight</td><td><?php echo $fPheno->getWeight();?> kg</td>
                        </tr>
                    </table> 
                        </tr>
                    </table>
